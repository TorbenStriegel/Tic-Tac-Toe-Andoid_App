...
public class Impressum_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView impressum = (TextView) findViewById(R.id.textView_Impessum);
        impressum.setText(Html.fromHtml("<div class='impressum'><h1>Impressum</h1><p>Angaben gemäß § 5 TMG</p><p>Torben Striegel <br> \n" +
                "Lerchenstraße 33<br> \n" +
                "79211 Denzlingen  <br> \n" +
                ...
                "Telefon: 0761-473843322<br>\n" +
                "E-Mail: <a href='mailto:torben.striegel@gmail.com'>torben.striegel@gmail.com</a></br></p><p><strong>Haftungsausschluss: </strong><br><br><strong>Haftung für Inhalte</strong><br><br>\n" +
                ...
                "Die Nutzung unserer App ist in der Regel ohne Angabe personenbezogener Daten möglich. Soweit auf unseren Seiten personenbezogene Daten (beispielsweise Name, Anschrift oder eMail-Adressen) erhoben werden, erfolgt dies, soweit möglich, stets auf freiwilliger Basis. Diese Daten werden ohne Ihre ausdrückliche Zustimmung nicht an Dritte weitergegeben. <br>\n" +
